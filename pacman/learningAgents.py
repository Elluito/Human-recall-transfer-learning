...
class ReinforcementAgent(ValueEstimationAgent):
    ...
    def final(self, state):
        ...
        # Append this episode's trail of Pacman positions to data/history so
        # plot_results.py can reproduce the position heatmaps (paper Figures
        # 13-14). Only meaningful for agents that track self.history
        # (QLearningAgent in qlearningAgents.py).
        if hasattr(self, "history"):
            with open("data/history", "a+b") as co:
